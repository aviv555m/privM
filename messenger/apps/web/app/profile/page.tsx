...
import { getFirebaseClients, updateUserProfile, updatePresence, type UserProfile, type UIPreset } from '@messenger/shared';
          ...
          <label>
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                if (!file) return;
                setPhotoURL(await fileToDataUrl(file, 512));
              }}
            />
          </label>
          ...
          <label>
            ...
            <input
              ...
              onChange={async (e) => {
                const file = e.target.files?.[0];
                if (!file) return;
                setBannerURL(await fileToDataUrl(file, 1400));
              }}
            />
          </label>
