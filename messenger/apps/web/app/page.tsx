...
export default function HomePage() {
  ...
  async function openChat(user: UserProfile) {
    ...
    try {
      ...
      setErrorMessage('Could not open this chat due to Firebase permissions. Please redeploy Firestore rules.');
    }
  }
    ...
    <main className="container">
      ...
      <section className="app-layout">
        <aside className="sidebar">
          {errorMessage ? (
            <p style={{ margin: '0 0 8px', color: '#ef4444', fontSize: 13 }}>{errorMessage}</p>
          ) : null}
